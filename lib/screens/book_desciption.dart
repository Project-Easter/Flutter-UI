...
class _BookDescriptionState extends State<BookDescription>
  ...
  Widget build(BuildContext context) {
    ...
    print('ISBM = ' + widget.bookFromList!.isbn.toString());
    print('USER ID = ' + widget.bookFromList!.userid.toString());
            ...
            ListView(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                      if (widget.bookFromList!.userid != uID)
                        Button(
                          name: 'Exchange this Book',
                          ...
                          myFunction: () async {
                            ...
                            // );
                            final bool res = await ChatService().createNewChat(
                                widget.bookFromList!.userid.toString(),
                                context);
                            if (!res) {
                              ChatService().openExistingChat(
                                  widget.bookFromList!.userid.toString(),
                                  context);
                            }
                          },
